!(function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports,require("lit-element")):"function"==typeof define&&define.amd?define(["exports","lit-element"],e):e((t=t||self).index={},t.common)})(this,function(t,e){"use strict";const i=function(){return"_"+Math.random().toString(36).substr(2,9)};customElements.define("in-radio",class extends e.LitElement{static get properties(){return{inName:{type:String,attribute:"in-name"},choices:{type:Array},choice:{type:String,reflect:!0}}}constructor(){super(),this.checked=[],this.genId=(function(){const t={};return function(e){return t[e]||(t[e]=i()),t[e]}})()}firstUpdated(){!this.choice&&this.choices&&(this.choice=this.choices[0])}inChange(t){this.choice=t.target.value;let e=new CustomEvent("choice-change",{detail:{choice:this.choice}});this.dispatchEvent(e)}render(){return e.html`
      ${this.choices.map((t,i)=>e.html`
        <div class="choice">
          <input 
            ...
            id="${this.genId(i)}" 
            value="${t}" 
            .checked="${this.choice===t}" 
            @change="${this.inChange}"
          >
          <label for="${this.genId(i)}">${t}</label>
        </div>
      `)}
    `}});class s extends e.LitElement{static get properties(){return{title:{type:String},trackTime:{type:Date,attribute:!1}}}constructor(){super(),this.renderTime=new Date}static get styles(){return e.css`
      :host {
    ...
    `}switchTab(t){t!==this.$views.choice&&(this.$views.choice=t),this.shadowRoot.querySelectorAll("slot").forEach(e=>{"default"===t&&!e.getAttribute("name")||e.getAttribute("name")===t?e.hidden=!1:e.hidden=!0})}handleChoiceChange(t){this.switchTab(t.detail.choice)}render(){return e.html`
      <style>
    ...
    `:""}
    `}});class o extends e.LitElement{static get properties(){return{siteinfo:{type:Object},photos:{type:Array}}}constructor(){super(),this.genId=(function(){const t={};return function(e){return t[e]||(t[e]=i()),t[e]}})()}static get styles(){return e.css`
      [data-element="table"] {
        display: grid;
    ...
    `}render(){return e.html`
      ...
      ${this.siteinfo?e.html`
        ...
        <div data-element="table">
          ${Object.entries(this.siteinfo).map((t,i)=>e.html`
            <td class="label">
              <label for="${this.genId(i)}">${t[0]}</label>
            </td>
            <td class="detail">
              <span id="${this.genId(i)}">${t[1]}</span>
            </td>
          `)}
        </div>
      `:""}
    `}}customElements.define("site-details",o),t.AppSidebar=s,t.SiteDetails=o,Object.defineProperty(t,"__esModule",{value:!0})});
